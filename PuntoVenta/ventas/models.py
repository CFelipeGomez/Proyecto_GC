...
from django.forms import model_to_dict #JSON MODELO
...
class Producto(models.Model):
    ...
    precio = models.DecimalField(max_digits=20, decimal_places=2, null =False, default= 0, blank = True)#blank= true vacion 
    cantidad = models.DecimalField(max_digits=15, decimal_places=2, null =False)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now_add=True)
#Para gregar espacio hacer migracion
    #Referencia
    class Meta:
